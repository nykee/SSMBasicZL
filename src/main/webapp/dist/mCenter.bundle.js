...
var option = {
    ...
    series: [{
        ...
        markLine: {
            ...
            data: [[{ name: '北京' }, { name: '上海' }], [{ name: '北京' }, { name: '贵阳' }], [{ name: '北京' }, { name: '广州' }], [{ name: '北京' }, { name: '长沙' }], [{ name: '北京' }, { name: '成都' }], [{ name: '北京' }, { name: '合肥' }], [{ name: '北京' }, { name: '长春' }], [{ name: '北京' }, { name: '济南' }], [{ name: '北京' }, { name: '武汉' }], [{ name: '上海' }, { name: '北京' }], [{ name: '上海' }, { name: '贵阳' }], [{ name: '上海' }, { name: '广州' }], [{ name: '上海' }, { name: '长沙' }], [{ name: '上海' }, { name: '成都' }], [{ name: '上海' }, { name: '合肥' }], [{ name: '上海' }, { name: '长春' }], [{ name: '上海' }, { name: '济南' }], [{ name: '上海' }, { name: '武汉' }], [{ name: '广州' }, { name: '北京' }], [{ name: '广州' }, { name: '贵阳' }], [{ name: '广州' }, { name: '上海' }], [{ name: '广州' }, { name: '长沙' }], [{ name: '广州' }, { name: '成都' }], [{ name: '广州' }, { name: '合肥' }], [{ name: '广州' }, { name: '长春' }], [{ name: '广州' }, { name: '济南' }], [{ name: '广州' }, { name: '武汉' }]]
        },
